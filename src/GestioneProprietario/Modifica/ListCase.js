...
class ListCase extends Component {
  ...
  componentDidMount() {
    ...
    fetch('https://uni-bnb-be.herokuapp.com/searchProprietaCVProprietario/proprietaCVProprietario', {
        method: "POST",
        headers: {
  ...
  if(this.state.error) {
    ...
    const listTitle = this.state.listBreadcrumb;
    const listBreadcrumb = this.state.listBreadcrumb;
    return (
      <ThemeProvider theme={theme}>
        <ListWrapper>
          ...
          <DragDropContext onDragEnd={this.onDragEnd}>
            <p>Si è verificato un errore: nessuna casa vacanza</p>
          </DragDropContext>
        </ListWrapper>
      </ThemeProvider>
    );
