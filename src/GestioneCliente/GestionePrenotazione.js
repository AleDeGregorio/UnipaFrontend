...
class GestionePrenotazione extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('https://uni-bnb-be.herokuapp.com/searchPrenotazioneCliente/prenotazioneCliente', {
            method:'POST',
            headers:{
   ...
   onChange = (e) => {
    ...
    onSubmitModifica = (e) => {
        ...
        this.setState({
            ...
            fetch('https://uni-bnb-be.herokuapp.com/updateDatePrenotazione/newDate', {
                method: "POST",
                headers: {
                    'Content-type' : 'application/json'
                },
    ...
    onSubmitElimina = (e) => {
        ...
        fetch('https://uni-bnb-be.herokuapp.com/deletePrenotazione/delete', {
            method: "POST",
            headers: {
                'Content-type' : 'application/json'
            },
    ...
    caricaDate = (tipo_proprieta, ref_proprieta, id_stanza) => {
        if(tipo_proprieta === 'cv') {
            ...
            fetch('https://uni-bnb-be.herokuapp.com/getDateCasa/dateCasa', { 
                method:'POST',
                headers:{
                    'Content-type':'application/json'
                },
            ...
            fetch('https://uni-bnb-be.herokuapp.com/getDateStanza/dateStanza', { 
                method:'POST',
                headers:{
                    'Content-type':'application/json'
                },
